...
parms0 <- c(R0_1=1.44,R0_2=1.60,a1=bestfitsparms[1,'a'],
            a2=bestfitsparms[1,'a'],sigma1=1/3.12,sigma2=1/2.28,
            ...
            theta1=bestfitsparms[1,'theta1'],
            theta2=bestfitsparms[1,'theta2'])
...
start1 <- c(S=0.9989,I1=0.0001,I2=0.001,V=0,R12=0,R1=0,R2=0,I12=0,I21=0,IV2=0,
           IV12=0,RT1=0,RT2=0,RV12=0,RV1=0,RV2=0,RVT2=0,IV1=0,RVT1=0,IV21=0)
start2 <- c(S=0.9989,I1=0.001,I2=0.0001,V=0,R12=0,R1=0,R2=0,I12=0,I21=0,IV2=0,
            IV12=0,RT1=0,RT2=0,RV12=0,RV1=0,RV2=0,RVT2=0,IV1=0,RVT1=0,IV21=0)
...
for (scaling in c(0.5,1,2)){
  ...
  simdf.list1 <- lapply(rel.rho,rel.parm=rel.parm,parms.init=parms1,odefunc=sirmod,
                        start.cond=start1,times.vec=times,sim)
...
save(simdf.meta.list,stats.sum,simdf.meta.list.vac.dur,
     stats.sum.vac.dur,file=paste0('initialCond2.RData'))
...
for (scaling in c(0.5,1,2)){
  ...
  simdf.list1 <- lapply(rel.rho,rel.parm=rel.parm,parms.init=parms1,odefunc=sirmod,
                        start.cond=start2,times.vec=times,sim)
  sumry.stats1 <- lapply(simdf.list1,sumry.cycl) %>% bind_rows()
  sumry.stats1 <- sumry.stats1 %>%
    mutate(scaling=scaling,vaccineImmunity='Bivalent vaccine')
...
save(simdf.meta.list,stats.sum,simdf.meta.list.vac.dur,
     stats.sum.vac.dur,file=paste0('initialCond3.RData'))
...
png('InitialConditionSensitivityTest_Strength.png',res=300,units='cm',width=13,height=14)
ggplot(stats.sum.all2,aes(x=vac.cov/52*100,group=param,colour=param,
  ...
  scale_color_manual(values=c('darkred','steelblue',
                              ...
                              mycolors['red50'][[1]],mycolors['blue50'][[1]]),
                     labels=c("H1 - initial condition 1",
                              "H3 - initial condition 1",
                              "H1 - initial condition 2",
                              "H3 - initial condition 2"),
...
png('InitialConditionSensitivityTest_Duration.png',res=300,units='cm',width=13,height=14)
