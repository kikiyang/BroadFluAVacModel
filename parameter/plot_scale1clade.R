...
library(ggplot2)
png('vac_all_scale1clade.png',res=300,units='cm',width=13,height=14)
...
stats.sum.vac.dur.all2 <- stats.sum.vac.dur.all %>%
  mutate(VacDur=paste("Relative duration of\nvaccinal vs natural\ncross-immunity:",1/scaling))

png('vac_dur_scale1clade.png',res=300,units='cm',width=13,height=14)
